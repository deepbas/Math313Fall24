...
::: font60
> Example 2: Use the random number table, select a random sample with size 10 from the list of States in U.S.A. use the last two digit on the $3^{rd}$ line and $1^{st}$ column as the starting point.
:::
...
```{r}
y <- c(92949493, 1963333, 21570527, 5124712, 1795045, 1379089, 29183290, 
4241500, 867770, 3013756)
y.bar <- mean(y)
y.bar
tau.hat <- 50 * y.bar
tau.hat
